...
function DraggableShift({ shift }) {
  ...
  return (
    <div ref={setNodeRef} {...attributes} {...listeners} className={`${isDragging ? 'opacity-80 scale-105 shadow-lg' : ''}`}>
      <div className="p-3 bg-white rounded-xl border border-gray-100 flex justify-between items-start shadow-sm">
        <div>
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center mb-2">
        ...
        <div className="flex gap-3 items-center">
          ...
          <button className="px-4 py-2 rounded-lg bg-[#0b2545] text-white text-sm shadow-md" onClick={() => onEdit && onEdit(null)}>+ Add Shift</button>
        </div>
      </div>
      ...
      <DndContext onDragStart={handleDragStart} onDragOver={handleDragOver} onDragEnd={handleDragEnd}>
        ...
        <DragOverlay>
          {activeShift ? (
            <div className="p-3 bg-[#07142b] text-white rounded-xl shadow-xl w-64">
