const STATUS_META = {
  confirmed: { label: 'Confirmed', bg: 'bg-emerald-100 text-emerald-800 border-emerald-200', dot: 'bg-emerald-500' },
  scheduled: { label: 'Scheduled', bg: 'bg-blue-100 text-blue-800 border-blue-200', dot: 'bg-blue-500' },
  pending: { label: 'Pending', bg: 'bg-amber-100 text-amber-800 border-amber-200', dot: 'bg-amber-500' },
  open: { label: 'Open Coverage', bg: 'bg-rose-100 text-rose-800 border-rose-200', dot: 'bg-rose-500' },
};
